...
// Make CRM_ActivityEntity_ExtensionUtil available.
require_once __DIR__ . '/../../activity_entity.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('activity-entity');
 ...
 */
function _activity_entity_test_civicrm_container(ContainerBuilder $container): void {
}
