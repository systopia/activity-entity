 ...
 */
class CRM_ActivityEntity_Upgrader_Base {

  /**
   * @var CRM_ActivityEntity_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_ActivityEntity_Upgrader(
        'activity-entity',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_ActivityEntity_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_ActivityEntity_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
