 ...
 */
final class DisconnectEntityAction extends AbstractAction {
  ...
  public function __construct(DAODeleteAction $deleteAction) {
    parent::__construct($deleteAction->getEntityName(), 'disconnectEntity');
  ...
  public function _run(Result $result): void {
    ...
    $deleteResult = $this->deleteAction->setWhere([
